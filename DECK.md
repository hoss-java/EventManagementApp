...
>   {
>     roles: [
>       { role: "readWrite", db: "eventmanapp" },
>       { role: "dbAdmin", db: "eventmanapp" }  // Add new role
>     ]
>   }
> )
> 
> mongosh -u "eventman" -p "eventmanpass" --authenticationDatabase "eventmanapp"
> 
> 
> mysql -u root -pmypass -h 172.32.0.16 < add-eventman.sql
> ```
> </details>
