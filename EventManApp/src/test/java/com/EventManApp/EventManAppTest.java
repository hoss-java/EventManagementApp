...
public class EventManAppTest
{
     ...
     * eventManager overload and inspects the recorded output.
     *
    ...
    void testEventManager_withStubs() throws Exception {
        ...
        // Act
        EventManApp.eventManager(testIn, testOut, new String[0]);
     ...
     * eventManager, then restores the original streams.
     *
    ...
    public void testEventManager() throws Exception {
        ...
        try {
            ...
            EventManApp.eventManager(System.in, System.out,new String[0]);
